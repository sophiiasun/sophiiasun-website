...
const About = () => {
	return (
		<>
			...
			<div class='header' style={{color:'var(--col1)', zIndex:'1000', display:'flex'}}>Everything begins with a thought, and thoughts are turned into plans, and plans into reality.</div>
				<div class="wrapper">
